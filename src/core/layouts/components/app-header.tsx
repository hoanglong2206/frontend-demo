...
export const AppHeader = () => {
	...
	return (
		<header className="sticky top-0 px-4 z-15 w-full bg-background/95 backdrop-blur shadow-sm">
			<div className="container flex h-15 items-center justify-between mx-auto">
				<motion.div
